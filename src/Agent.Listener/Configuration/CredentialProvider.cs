...
namespace Microsoft.VisualStudio.Services.Agent.Listener.Configuration
{
    ...
    public sealed class PersonalAccessToken : CredentialProvider
    {
        ...
        public override VssCredentials GetVssCredentials(IHostContext context)
        {
            ...
            trace.Info(StringUtil.SafeLog("token retrieved: {0} chars", token.Length));
    ...
    public sealed class AlternateCredential : CredentialProvider
    {
        ...
        public override VssCredentials GetVssCredentials(IHostContext context)
        {
            ...
            trace.Info(StringUtil.SafeLog("username retrieved: {0} chars", username.Length));
            trace.Info(StringUtil.SafeLog("password retrieved: {0} chars", password.Length));
    ...
    public sealed class ServicePrincipalCredential : CredentialProvider
    {
        ...
        public override VssCredentials GetVssCredentials(IHostContext context)
        {
            ...
            trace.Info(StringUtil.SafeLog("tenant id retrieved: {0} chars", tenantId.Length));
            ...
            trace.Info(StringUtil.SafeLog("client id retrieved: {0} chars", clientId.Length));
            ...
            trace.Info(StringUtil.SafeLog("client secret retrieved: {0} chars", clientSecret.Length));
