...
namespace Microsoft.VisualStudio.Services.Agent.Worker.TestResults
{
    ...
    public interface ILegacyTestRunPublisher : IAgentService
    {
        ...
        Task<TestRun> StartTestRunAsync(LegacyTestRunData testRunData, CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task EndTestRunAsync(LegacyTestRunData testRunData, int testRunId, bool publishAttachmentsAsArchive = false, CancellationToken cancellationToken = default(CancellationToken));
        LegacyTestRunData ReadResultsFromFile(TestRunContext runContext, string filePath, string runName);
        LegacyTestRunData ReadResultsFromFile(TestRunContext runContext, string filePath);
    }

    public class LegacyTestRunPublisher : AgentService, ILegacyTestRunPublisher
    {
        #region Private
        ...
        /// Start a test run
        /// </summary>
        public async Task<TestRun> StartTestRunAsync(LegacyTestRunData testRunData, CancellationToken cancellationToken)
        {
            Trace.Entering();
        ...
        /// </summary>
        public async Task EndTestRunAsync(LegacyTestRunData testRunData, int testRunId, bool publishAttachmentsAsArchive = false, CancellationToken cancellationToken = default(CancellationToken))
        {
            Trace.Entering();
        ...
        public LegacyTestRunData ReadResultsFromFile(TestRunContext runContext, string filePath)
        {
            Trace.Entering();
        ...
        /// <returns>TestRunData</returns>
        public LegacyTestRunData ReadResultsFromFile(TestRunContext runContext, string filePath, string runName)
        {
            Trace.Entering();
