...
namespace Microsoft.VisualStudio.Services.Agent
{
    ...
    public sealed class Terminal : AgentService, ITerminal
    {
        ...
        public override void Initialize(IHostContext hostContext)
        {
            ...
            {
                Trace.Warning($"Failed to set console output encoding to '{terminalEncoding.WebName}'");
            ...
            catch (Exception ex)
            {
                ...
                Trace.Warning($"Failed to set console encoding to {terminalEncoding.EncodingName}");
                Trace.Warning(ex.ToString());
            }
        }
