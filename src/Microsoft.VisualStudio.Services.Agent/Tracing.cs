...
#pragma warning disable CA1716 // Identifiers should not match keywords - maintaining compatibility
        ...
        public virtual void Entering([CallerMemberName] string name = "", [CallerMemberName] string operation = "")
        {
            Trace(TraceEventType.Verbose, $"Entering {name}");
        }

        public virtual void Leaving([CallerMemberName] string name = "", [CallerMemberName] string operation = "")
        {
